...
insert into Habitacao(idHabitacao,numQuartos, maxHospedes,morada, precoNoite, taxaLimpeza, classificacaoHabitacao, idCidade, idTipo, idPolitica, descricao) values (1,3,7,"Av. Afonso Henriques 9035", 35, 15, NULL, 7, 2,4, NULL);
insert into Habitacao(idHabitacao,numQuartos, maxHospedes,morada, precoNoite, taxaLimpeza, classificacaoHabitacao, idCidade, idTipo, idPolitica, descricao) values (2,5,10,"Rua S. Caetano, s/n", 40, 8, NULL, 8, 2,1, NULL);
insert into Habitacao(idHabitacao,numQuartos, maxHospedes,morada, precoNoite, taxaLimpeza, classificacaoHabitacao, idCidade, idTipo, idPolitica, descricao) values (3,1,2,"Rua da Boavista", 35, 50, NULL, 1, 6,3, NULL);
insert into Habitacao(idHabitacao,numQuartos, maxHospedes,morada, precoNoite, taxaLimpeza, classificacaoHabitacao, idCidade, idTipo, idPolitica, descricao) values (4,1,1,"Praceta Joao XXI", 80, 5, NULL, 3, 5,2, NULL);
insert into Habitacao(idHabitacao,numQuartos, maxHospedes,morada, precoNoite, taxaLimpeza, classificacaoHabitacao, idCidade, idTipo, idPolitica, descricao) values (5,4,9,"Av. Esteves Alberto 645", 33, 15, NULL, 8, 6,2, NULL);
insert into Habitacao(idHabitacao,numQuartos, maxHospedes,morada, precoNoite, taxaLimpeza, classificacaoHabitacao, idCidade, idTipo, idPolitica, descricao) values (6,3,3,"Rua D.Pedro III, s/n", 40, 3, NULL, 7, 2,1, NULL);
insert into Habitacao(idHabitacao,numQuartos, maxHospedes,morada, precoNoite, taxaLimpeza, classificacaoHabitacao, idCidade, idTipo, idPolitica, descricao) values (7,2,4,"Rua da Trindade", 43, 30, NULL, 3, 2,3, NULL);
insert into Habitacao(idHabitacao,numQuartos, maxHospedes,morada, precoNoite, taxaLimpeza, classificacaoHabitacao, idCidade, idTipo, idPolitica, descricao) values (8,1,2,"Praca Joao I", 23, 44, NULL, 3, 5,2, NULL);
insert into Habitacao(idHabitacao,numQuartos, maxHospedes,morada, precoNoite, taxaLimpeza, classificacaoHabitacao, idCidade, idTipo, idPolitica, descricao) values (9,3,7,"Rua do Algarve, 23", 23, 44, NULL, 7, 2, 2, NULL);

insert into Habitacao(idHabitacao,numQuartos, maxHospedes,morada, precoNoite, taxaLimpeza, classificacaoHabitacao, idCidade, idTipo, idPolitica, descricao) values (10,3,5,"Rua do Olhar, 23", 50, 21, NULL, 7, 2, 2, NULL);
insert into Habitacao(idHabitacao,numQuartos, maxHospedes,morada, precoNoite, taxaLimpeza, classificacaoHabitacao, idCidade, idTipo, idPolitica, descricao) values (11,3,3,"Rua da Gaivota, 30", 70, 15, NULL, 7, 2, 2, NULL);
insert into Habitacao(idHabitacao,numQuartos, maxHospedes,morada, precoNoite, taxaLimpeza, classificacaoHabitacao, idCidade, idTipo, idPolitica, descricao) values (12,3,10,"Praca D. Pedro, 10", 300, 20, NULL, 7, 2, 2, NULL);
insert into Habitacao(idHabitacao,numQuartos, maxHospedes,morada, precoNoite, taxaLimpeza, classificacaoHabitacao, idCidade, idTipo, idPolitica, descricao) values (13,3,5,"Rua do Mar, 1", 23, 100, NULL, 7, 2, 2, NULL);
insert into Habitacao(idHabitacao,numQuartos, maxHospedes,morada, precoNoite, taxaLimpeza, classificacaoHabitacao, idCidade, idTipo, idPolitica, descricao) values (14,3,6,"Rua da Alegria, 1000", 20, 36, NULL, 7, 2, 2, NULL);
insert into Habitacao(idHabitacao,numQuartos, maxHospedes,morada, precoNoite, taxaLimpeza, classificacaoHabitacao, idCidade, idTipo, idPolitica, descricao) values (15,3,8,"Rua do Sal, 14", 60, 10, NULL, 7, 2, 2,NULL);
insert into Habitacao(idHabitacao,numQuartos, maxHospedes,morada, precoNoite, taxaLimpeza, classificacaoHabitacao, idCidade, idTipo, idPolitica, descricao) values (16,3,4,"Rua da Areia, 70", 85, 100, NULL, 7, 2, 2, NULL);
insert into Habitacao(idHabitacao,numQuartos, maxHospedes,morada, precoNoite, taxaLimpeza, classificacaoHabitacao, idCidade, idTipo, idPolitica, descricao) values (17,3,7,"Rua do Algarve, 500", 890, 20, NULL, 7, 2, 2, NULL);
